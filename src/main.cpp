...
uint256 hashGenesisBlock("0x21bb18f6b1d8be1a8351d67c82f0b0f8a46afa85a2898861e15762b63d8f83e1");
...
const string strMessageMagic = "dieudocoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 60 * 60; // dieudocoin: 6 hour recalculations
static const int64 nTargetSpacing = 120; // dieudocoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dieudocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dieudocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Arutz Sheva 27/Dec/2013 Hezbollah Denies it Killed Former Lebanese Minister - about two weeks after this headline.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389989716; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 552336;

        if (fTestNet)
        {
            block.nTime    = 1389438077;
            block.nNonce   = 552336;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5b0e078318fad7536fb3ff94658b42df199ae60bfcf4640d0714b486112dedb2"));
